...
| 9 | I7 | Rede transacional e planner backend-neutral | `EM ANDAMENTO` 2026-08-26 (`I7.1`, `I7.2` e `I7.3` concluídas) | `network.py`, REQ-NET-TX |
...
| I7 | | | | | em andamento (`I7.1`, `I7.2` e `I7.3` de 7 concluídas; `I7.7` com núcleo pronto) | Gate I7 exige I7.4–I7.6 e revisão específica de rollback | | executar I7.4 |
