...
| 9 | I7 | Rede transacional e planner backend-neutral | `EM ANDAMENTO` 2026-08-27 (`I7.1` a `I7.5` concluídas) | `network.py`, REQ-NET-TX |
...
| I7 | | | | | em andamento (`I7.1`–`I7.5` e núcleo de `I7.7` concluídos) | Gate I7 exige I7.6 e revisão específica de rollback | | executar I7.6 |
