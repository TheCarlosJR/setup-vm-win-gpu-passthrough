...
| 9 | I7 | Rede transacional e planner backend-neutral | `EM ANDAMENTO` 2026-08-26 (`I7.1` e `I7.2` concluídas) | `network.py`, REQ-NET-TX |
...
| I7 | | | | | em andamento (`I7.1` e `I7.2` de 7 concluídas) | Gate I7 exige I7.3–I7.7 e revisão específica de rollback | | executar I7.3 |
